...
\NewDocumentCommand{\ThinEdgeAndCircle}{m m m O{} O{} O{}}{
\begin{tikzpicture}[thick,baseline=(current bounding box.center)]
...
%gradings
\node[anchor=center]  at (0.7,0.7) {#4};
\node[anchor=center]  at (0.7,-0.7) {#5};
\node[anchor=center] at (-0.7,-0.7) {#6};

\end{tikzpicture}
}

\NewDocumentCommand{\SingleEdge}{m m O{} O{} O{}}{
\begin{tikzpicture}[thick,baseline=(current bounding box.center)]
...
%gradings
\node[anchor=center]  at (0.7,0.7) {#3};
\node[anchor=center]  at (0.7,-0.7) {#4};
\node[anchor=center] at (-0.7,-0.7) {#5};	
...
\NewDocumentCommand{\ThickEdgeAndCircle}{m m m O{} O{} O{}}{
\begin{tikzpicture}[thick,baseline=(current bounding box.center)]
...
\draw[dotted, dash pattern=on 1pt off 1pt, line width=0.5pt, Stealth-] (-0.21,0) -- (0.21,0);
...
% Central dotted edge and dash
\draw[dotted, dash pattern=on 1pt off 1pt, line width=0.5pt, Stealth-] (0,-0.21) -- (0,0.21);
...
\newcommand{\UnorientedVerticalThinEdge}[5]{
	\begin{tikzpicture}[thick,baseline=(current bounding box.center)]
		...
		% Central dotted edge and dash 
		\draw[dotted, dash pattern=on 1pt off 1pt, line width=0.5pt, #5] (0,-0.21) -- (0,0.21);
...
\newcommand{\thinre}[1]{
	...
	\draw[dotted, dash pattern=on 1pt off 1pt, -{>[scale=0.8]}]
	($(-180:#1/3)$)
	.. controls +({0}:0.2) and +(180:0.2)
	.. ($(0:#1/3)$);
...
\newcommand{\thikre}[1]{
	...
	\draw[line width=2pt, {Stealth[scale=0.4]}-]
	($(-90:#1/2.5)$)
	.. controls +({90}:0.2) and +(-90:0.2)
	.. ($(90:#1/2.5)$);
...
\NewDocumentCommand{\RLR}{m m m O{} O{} O{} O{0}}{
	\begin{tikzpicture}[baseline=(current bounding box.center)]
		...
		%labels
		\ifnum #7=1
			\node[anchor=center]  at (0.1,0) {$u$}; 
			\node[anchor=center]  at (-0.35,-0.5) {$x_2$}; 
			\node[anchor=center]  at (-0.8,0) {$x_1$}; 
			\node[anchor=center]  at (-0.45,0.55) {$x_0$};
			\node[anchor=center]  at (0.2,-0.8) {$x_3$}; 
			\node[anchor=center]  at (0.75,0) {$x_4$};
			\node[anchor=center]  at (0.2,0.81) {$x_5$}; 
		\fi
	\end{tikzpicture}
}
\NewDocumentCommand{\LRL}{m m m O{} O{} O{} O{0}}{
\begin{tikzpicture}[baseline=(current bounding box.center)]
	\coordinate (O) at (0,0);
	\coordinate (A) at (-0.2,0.5);
	...
	\ifnum #7=1
		\node[anchor=center]  at (-0.1,0) {$u$}; 
		\node[anchor=center]  at (0.35,-0.5) {$x_3$}; 
		\node[anchor=center]  at (0.8,0) {$x_4$}; 
		\node[anchor=center]  at (0.45,0.55) {$x_5$};
		\node[anchor=center]  at (-0.2,-0.8) {$x_2$}; 
		\node[anchor=center]  at (-0.75,0) {$x_1$};
		\node[anchor=center]  at (-0.2,0.81) {$x_0$}; 
	\fi
\end{tikzpicture}
...
\NewDocumentCommand{\LR}{m m O{} O{} O{} O{0}}{
	\begin{tikzpicture}[baseline=(current bounding box.center)]
		\coordinate (O) at (0,0);
		...
		% Labels for regions 
		\ifnum #6=1
			\node[anchor=center]  at (-0.35,-0.3) {$x_2$}; 
			\node[anchor=center]  at (-0.75,0.22) {$x_1$}; 
			\node[anchor=center]  at (-0.25,0.7) {$x_0$};
			\node[anchor=center]  at (0.32,-0.65) {$x_3$}; 
			\node[anchor=center]  at (0.7,-0.25) {$x_4$};
			\node[anchor=center]  at (0.35,0.3) {$x_5$}; 
		\fi
		\ifnum #6=2
			\node[anchor=center]  at (-0.35,-0.3) {$x_2$}; 
			\node[anchor=center]  at (-0.75,0.22) {$x_1$}; 
			...
			\node[anchor=center]  at (0.32,-0.65) {$x_3$}; 
			\node[anchor=center]  at (0.7,-0.25) {$x_4$};
			\node[anchor=center]  at (0.35,0.3) {$u$}; 
		\fi
	\end{tikzpicture}	
}
\NewDocumentCommand{\RL}{m m O{} O{} O{} O{0}}{
	\begin{tikzpicture}
		\coordinate (O) at (0,0);
		\coordinate (A) at (0.3,0.3);
		\coordinate (B) at (-0.3,-0.3);
		...
		\ifnum #6=1
			\node[anchor=center]  at (0.35,-0.3) {$x_3$}; 
			\node[anchor=center]  at (0.75,0.22) {$x_4$}; 
			\node[anchor=center]  at (0.25,0.7) {$x_5$};
			\node[anchor=center]  at (-0.32,-0.65) {$x_2$}; 
			\node[anchor=center]  at (-0.7,-0.25) {$x_1$};
			\node[anchor=center]  at (-0.35,0.3) {$x_0$}; 
		\fi
	\end{tikzpicture}	
}

\NewDocumentCommand{\RER}{m m O{} O{} O{} O{0}}{
	\begin{tikzpicture}[baseline=(current bounding box.center)]
	\coordinate (O) at (0,0);
	\coordinate (A) at (0.2,0.5);
	\coordinate (C) at (0.2,-0.5);
	...
	%labels
	\ifnum #6=1
	\node[anchor=center]  at (0.2,0) {$x_1$}; 
	\node[anchor=center]  at (-0.35,-0.5) {$x_2$}; 
	\node[anchor=center]  at (-0.45,0.55) {$x_0$};
	\node[anchor=center]  at (0.2,-0.8) {$x_3$}; 
	\node[anchor=center]  at (0.75,0) {$x_4$};
